...
st.set_page_config(
    ...
    page_icon="logo.png",        # This looks for logo.png in your folder
    layout="wide",
    initial_sidebar_state="expanded"
)

# --- CUSTOM LOGO ---
# This puts your logo in the top-left sidebar
st.logo(
    "logo.png",
...
# --- CLEANUP CSS (Hides "Made with Streamlit") ---
...
# --- MAIN UI ---
    ...
    # 1. Sidebar Logo (Big & Visible)
    st.sidebar.image("logo.png", use_container_width=True)

    # 2. Main Page Logo (Centered & Medium size)
    col1, col2, col3 = st.columns([1, 2, 1]) # Create 3 columns to center it
    with col2:
        st.image("logo.png", width=200)      # Put logo in the middle column

    st.title("🚀 Career Pivot Report Generator")
