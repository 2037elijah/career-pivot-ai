...
st.set_page_config(
    ...
    page_icon="logo_v2.png",        # This looks for logo.png in your folder
    layout="wide",
...
if check_password():
    ...
    # --- MAIN UI (UPDATED FOR CLEAN HEADER) ---
    
# Create 2 columns: Give the logo more space (ratio 2:5 instead of 1:5)
    col1, col2 = st.columns([2, 5]) 
    
    with col1:
        # Increased width from 100 to 250 for clarity
        st.image("logo_v2.png", width=250) 

    with col2:
        # Title on the right, aligned with logo
